...
//           syncBlocks();
//         });
//         blockNode = createElement("div", { class: "block block-text" }, [
//           createElement("span", { class: "block-label" }, ["Text Block"]),
//           input
//         ]);
//       } else if (block.type === "image") {
//         const fileInput = createElement("input", { type: "file", accept: "image/*" });
//         fileInput.addEventListener("change", () => {
//           blocks[i].placeholder = fileInput.files.length ? fileInput.files[0].name : "";
//           syncBlocks();
//         });
//         blockNode = createElement("div", { class: "block block-image" }, [
//           createElement("span", { class: "block-label" }, ["Image Block"]),
//           fileInput
//         ]);
//       }
