...
function addTicketForm(eventId, ticketList) {
    ...
    currencyOptions.forEach(currency => currencySelect.appendChild(createElement("option", { value: currency }, [currency])));
...
export { addTicketForm, addTicket, displayNewTicket, displayTickets };
