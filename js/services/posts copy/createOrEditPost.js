...
//   const categoryGroup = createTextGroup({
//     id: "category",
//     label: "Category",
//     value: existingPost?.category || "General",
//     placeholder: "e.g. Blog",
//     required: true
//   });

//   const subcategoryGroup = createTextGroup({
//     id: "subcategory",
//     label: "Subcategory",
//     value: existingPost?.subcategory || "General",
...
//       formData.append("type", typeKey);
//       formData.append("title", titleGroup.querySelector("input").value.trim());
//       formData.append("category", categoryGroup.querySelector("input").value.trim());
//       formData.append("subcategory", subcategoryGroup.querySelector("input").value.trim());
