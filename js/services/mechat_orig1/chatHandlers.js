...
export function resetCurrentChatId() {
  currentChatId = null;
}
  ...
  chats.forEach(chat => {
    ...
    btn.addEventListener("click", async () => {
      ...
      backBtn.addEventListener("click", () => {
        ...
        document.querySelector(".chat-sidebar")?.removeAttribute("inert");
        resetCurrentChatId();
      });

      chatModal.appendChild(backBtn);
      document.querySelector(".chat-sidebar")?.setAttribute("inert", "true");
