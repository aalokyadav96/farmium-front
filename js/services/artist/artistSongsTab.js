...
//     let footer = document.getElementById("global-player");
//     if (footer) return footer;

//     footer = createElement("footer", { id: "global-player", class: "global-player" });
//     const audio = createElement("audio", { id: "global-audio", controls: true });
...
//                 const audio = globalPlayer.querySelector("#global-audio");
...
//                     currentPlayBtn.innerHTML = playSVG;
//                 }
...
//     return createElement("form", { class: "song-form" }, [
//         createFormGroup({ type: "text", name: "title", label: "Title", value: song.title || "", placeholder: "Song Title", required: true }),
//         createFormGroup({ type: "text", name: "genre", label: "Genre", value: song.genre || "", placeholder: "Genre", required: true }),
//         createFormGroup({ type: "text", name: "duration", label: "Duration", value: song.duration || "", placeholder: "Duration", required: true }),
//         createFormGroup({ type: "text", name: "description", label: "Description", value: song.description || "", placeholder: "Description (optional)" }),
//         audioGroup,
//         imageGroup,
//         createElement("button", { type: "submit" }, [song.songid ? "Save Changes" : "Add Song"]),
//     ]);
...
// //         const list = createElement("ul", {class:"songslist"}, []);
// //         songs.forEach(song => {
// //             if (!song.published && !isCreator) return;
...
// //     return createElement("form", { class: "song-form" }, [
// //         createFormGroup({
// //             type: "text", name: "title", label: "Title", value: song.title || "", placeholder: "Song Title", required: true
// //         }),
// //         createFormGroup({
// //             type: "text", name: "genre", label: "Genre", value: song.genre || "", placeholder: "Genre", required: true
// //         }),
// //         createFormGroup({
// //             type: "text", name: "duration", label: "Duration", value: song.duration || "", placeholder: "Duration", required: true
// //         }),
// //         createFormGroup({
// //             type: "text", name: "description", label: "Description", value: song.description || "", placeholder: "Description (optional)"
// //         }),
// //         audioGroup,
// //         imageGroup,
// //         createElement("button", { type: "submit" }, [song.songid ? "Save Changes" : "Add Song"]),
