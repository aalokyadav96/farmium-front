...
//     }, [
//         createElement("span", { class: "msg-sender" }, [`${msg.sender}: `]),
//         createElement("span", { class: "msg-content" }, contentNode)
//     ]);
// }

// function renderAttachment(att) {
//     const { id, url, type, sender } = att;
//     let contentEl;
//     if (type.startsWith("image/")) {
//         contentEl = createElement("img", { src: url, class: "msg-image", alt: "" });
//     } else {
//         contentEl = createElement("a", { href: url, download: "", class: "msg-file" }, [
//             url.split("/").pop()
//         ]);
//     }
//     return createElement("div", {
...
//         dataset: { id }
//     }, [
//         createElement("span", { class: "msg-sender" }, [`${sender}: `]),
//         contentEl
//     ]);
// }
